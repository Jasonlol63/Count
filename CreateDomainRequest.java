...
public class CreateDomainRequest {
    ...
    private List<TenantSaveDto> groups = new ArrayList<>();

    private List<TenantSaveDto> companies = new ArrayList<>();

    @Service
    public static class DomainServiceImpl implements DomainService {
        ...
        public List<DomainDTO> findAllDomainList() {
            try {
                ...
                throw new com.eazycount.common.BusinessException("Failed to load Domain List. Please try again.");
            }
        }
        ...
        public DomainListItemDto createDomain(CreateDomainRequest request) {
            if (request == null) {
                throw new com.eazycount.common.BusinessException("Request body is required.");
            }
        ...
        public DomainListItemDto updateDomain(UpdateDomainRequest request) {
            if (request == null || request.getId() == null || request.getId() <= 0) {
                throw new com.eazycount.common.BusinessException("Owner id is required.");
            }
            ...
            if (existing == null) {
                throw new com.eazycount.common.BusinessException("Owner ID not found!");
            }
            ...
            for (TenantSaveDto companyRow : companyRows) {
                ...
                if (company == null) {
                    ...
                    if (parentGroupCode != null) {
                        ...
                        if (parentId == null) {
                            throw new com.eazycount.common.BusinessException("Parent group not found for company: " + code);
                        }
        ...
        public void deleteDomain(Integer domainId) {
            if(domainId == null){
                throw new com.eazycount.common.BusinessException("Domain id is null");
            }

            Owner existing = authDao.findOwnerById(domainId);
            if(existing == null){
                throw new com.eazycount.common.BusinessException("Owner not found");
            }
            ...
            for (Tenant tenant : tenants) {
                if ("C168".equals(normalizeCode(tenant.getCode()))) {
                    throw new com.eazycount.common.BusinessException("Cannot delete owners containing C168.");
                }
            }
            ...
            try{
                ...
                throw new com.eazycount.common.BusinessException("Failed to delete domain. Please try again.");
            }
        ...
        private void prepareOwnerForUpdate(Owner owner, Owner existing) {
            if (isBlank(owner.getName()) || isBlank(owner.getEmail())) {
                throw new com.eazycount.common.BusinessException("Name and email are required.");
            }
            ...
            if (isBlank(owner.getSecondaryPassword())) {
                ...
                if (!SECONDARY_PASSWORD_PATTERN.matcher(owner.getSecondaryPassword()).matches()) {
                    throw new com.eazycount.common.BusinessException("Secondary password must be exactly 6 digits.");
                }
        ...
        private DomainListItemDto insertNewDomain(Owner owner, List<Tenant> groups, List<Tenant> companies) {
            if (owner == null) {
                throw new com.eazycount.common.BusinessException("Owner information is required.");
            }
            if (owner.getId() != null) {
                throw new com.eazycount.common.BusinessException("Use update API for existing owners.");
            }
            ...
            final Integer ownerId = owner.getId();
            if (ownerId == null) {
                throw new com.eazycount.common.BusinessException("Failed to create owner.");
            }
        ...
        public void validateDomainCode(String code, Integer excludeOwnerId) {
            ...
            if (normalized == null) {
                throw new com.eazycount.common.BusinessException("Code is required.");
            }
        ...
        public void addOwnerDetail(Owner owner) {
            try{
                ...
                throw new com.eazycount.common.BusinessException("Failed to insert Owner. Please try again.");
            }
        }
        ...
        public void updateOwnerDetail(Owner owner) {
            ...
            try {
                ...
                throw new com.eazycount.common.BusinessException("Failed to update Owner. Please try again.");
            }
        }
        ...
        public void updateTenantDetail(Tenant tenant) {
            if (tenant == null || tenant.getId() == null) {
                throw new com.eazycount.common.BusinessException("Tenant ID is required!");
            }
            if (authDao.findTenantById(tenant.getId()) == null) {
                throw new com.eazycount.common.BusinessException("Tenant ID not found!");
            }
            try {
                domainDao.updateTenantDetail(tenant);
            } catch (Exception e) {
                throw new com.eazycount.common.BusinessException("Failed to update Tenant. Please try again.");
            }
        }
        @Override
        public void addTenantDetail(Tenant tenant) {
            try{
                ...
                throw new com.eazycount.common.BusinessException("Failed to insert Tenant. Please try again.");
            }
        }
        ...
        public void deleteOwner(Integer ownerId) {
            ...
            try{
                ...
                throw new com.eazycount.common.BusinessException("Failed to delete Owner. Please try again.");
            }
        }
        ...
        public void deleteTenant(Integer tenantId) {
            ...
            try{
                ...
                throw new com.eazycount.common.BusinessException("Failed to delete Tenant. Please try again.");
            }
        }
        ...
        public DomainFee findFeeSetting() {
            try {
                ...
                throw new com.eazycount.common.BusinessException("Failed to load domain fee settings. Please try again!");
            }
        }
        ...
        public void updateFee(DomainFee domainFee) {
            try {
                ...
                throw new com.eazycount.common.BusinessException("Failed to save domain fee settings. Please try again!");
            }
        }
        ...
        private void prepareOwnerForInsert(Owner owner) {
            if (isBlank(owner.getOwnerCode()) || isBlank(owner.getName()) || isBlank(owner.getEmail())) {
                throw new com.eazycount.common.BusinessException("Owner code, name and email are required.");
            }
            if (isBlank(owner.getPassword()) || isBlank(owner.getSecondaryPassword())) {
                throw new com.eazycount.common.BusinessException("Password and secondary password are required.");
            }
            if (!SECONDARY_PASSWORD_PATTERN.matcher(owner.getSecondaryPassword()).matches()) {
                throw new com.eazycount.common.BusinessException("Secondary password must be exactly 6 digits.");
            }
        ...
        private void prepareGroupForInsert(Tenant group, Integer ownerId, String createdBy) {
            ...
            if (code == null) {
                throw new com.eazycount.common.BusinessException("Group code is required.");
            }
        ...
        private void prepareCompanyForInsert(
            ...
            if (code == null) {
                throw new com.eazycount.common.BusinessException("Company code is required.");
            }
